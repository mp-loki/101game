...
public class DealProcessor {
	...
	public TerminalDto processDealEnd(Table table) {
	...
	public TerminalDto processGameEnd(Table table) {
		// TODO add game and processing
		return DtoFactory.getGameEndedDto(table, "Game Ended");
	}
	
	public ActionResult processDealStart(Table table) {
